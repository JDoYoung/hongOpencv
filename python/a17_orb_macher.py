...
def main():
    try:
        book = cv2.imread("/home/aa/hongOpencv/data/box.png") # 여기에 찾고싶은거 타겟
        if book is None:
    ...
    while True:
        ...
        # frame = cv2.imread("/home/aa/hongOpencv/data/box_in_scene.png") # 사진에서 물건을 찾고 싶을 때
